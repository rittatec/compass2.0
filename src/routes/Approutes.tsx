  ...
  // NAVBAR COM TAB 
  function TabRoutes({ expoPushToken }: any) {
    return (
      <Tab.Navigator
        screenOptions={{
      ...
      >
        ...
        >
          {props => <Notificacoes {...props} expoPushToken={expoPushToken} />}
        </Tab.Screen>
      </Tab.Navigator>
    );
  }
  ...
  export default function AppRoutes({ expoPushToken }: any) {
    return (
      <Stack.Navigator initialRouteName="Inicio">
        ...
        <Stack.Screen name="Menu" options={{ headerShown: false }}>
          {props => <TabRoutes {...props} expoPushToken={expoPushToken} />}
        </Stack.Screen>
