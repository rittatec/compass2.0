// src/screens/Poupanca.tsx
import { useState } from 'react';
import { View, Text, StyleSheet, TextInput, TouchableOpacity, Alert } from 'react-native';
import { useNavigation, NavigationProp } from '@react-navigation/native';
import { salvarPoupanca } from '../services/poupançaservice'; // import do service
...
export default function Poupanca() {
  ...
  const handleSave = async () => {
    try {
      await salvarPoupanca({ amount: parseFloat(amount) }); // chama o service
      Alert.alert('Sucesso', `Valor da Poupança salvo: R$ ${amount}`);
