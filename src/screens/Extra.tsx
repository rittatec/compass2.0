...
import { salvarExtra } from '../services/extraservice'; // import do service
...
export default function Extra() {
  ...
  const handleSave = async () => {
    try {
      await salvarExtra({ amount: parseFloat(amount) }); // chama service
      Alert.alert('Sucesso', `Valor de Extra salvo: R$ ${amount}`);
